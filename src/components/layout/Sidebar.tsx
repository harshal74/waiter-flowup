...
export default function Sidebar({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed top-0 left-0 bottom-0 z-30 w-64 bg-gray-900 border-r border-gray-800
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-800">
          ...
          <div>
            <p className="font-bold text-white text-sm">FlowUp</p>
        ...
        {/* Staff badge */}
        {staff && (
          <div className="mx-4 mt-4 px-3 py-2.5 rounded-xl bg-gray-800 flex items-center gap-3">
